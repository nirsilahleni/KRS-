...
@section('content')
    <div class="mt-2">
        <form action="{{ route('master.kader.store') }}" method="post" id="create-kader_form">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <x-atoms.input name="nik" maxlength="16" minlength="16" id="nik" placeholder="Masukkan NIK" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <x-atoms.form-label for="email" required>Email</x-atoms.form-label>
                    <x-atoms.input type="email" name="email" id="email" placeholder="Masukkan Alamat Email" />
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <x-atoms.input name="nomor_hp" id="nomor_hp" placeholder="Masukkan Nomor HP" type="number"
                        value="Masukkan Nomor HP" />
                </div>
                <div class="col-md-3 mb-3">
                    <x-atoms.form-label for="rt" required>RT</x-atoms.form-label>
                    <x-atoms.input name="rt" id="rt" placeholder="0" type="number" />
                </div>
                <div class="col-md-3 mb-3">
                    <x-atoms.form-label for="rw" required>RW</x-atoms.form-label>
                    <x-atoms.input name="rw" id="rw" placeholder="0" type="number" />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <x-atoms.input name="alamat" id="alamat" placeholder="Masukkan Alamat" />
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <x-atoms.select2 name="kelurahan_id" id="kelurahan_id" placeholder="Pilih Kelurahan" disabled />
                </div>

                <div class="col-md-6 mb-3">
                    <x-atoms.form-label for="posyandu_id" required>Posyandu</x-atoms.form-label>
                    <x-atoms.select2 name="posyandu_id" id="posyandu_id" placeholder="Pilih Posyandu" disabled />
                </div>
            </div>
    ...
    @push('scripts')
        <script>
            $(document).on("form-submitted:create-kader_form", function(ev) {
