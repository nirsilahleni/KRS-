@can($globalModule['create'])
    <x-mollecules.modal id="add-kategori_berita_modal" action="{{ route('cms.kategori-berita.store') }}" method="POST"
...
@can($globalModule['update'])
    <x-mollecules.modal id="edit-kategori_berita_modal" action="/cms/kategori-berita/{id}" method="PUT"
