...
@section('content')
    <div class="carousel-owl gap-2">
        <div class="item-widget col-3">
            <div class="card border-0 zoom-in bg-light-info shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <h5 class="fw-semibold text-info mb-0">{{ $kk }}</h5>
                    </div>
                </div> 
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/svgs/icon-favorites.svg') }}" width="50" height="50"
                            class="mb-3" alt="" />
                        <p class="fw-semibold fs-3 text-danger mb-1">Total Balita</p>
                        <h5 class="fw-semibold text-danger mb-0">{{ $balita }}</h5>
                    </div>
                </div>
            </div>
        </div>
        <div class="item-widget col-3">
            <div class="card border-0 bg-light-primary shadow-none">
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/svgs/nodata-pekerjaan.svg') }}" width="50" height="50"
                            class="mb-3" alt="" />
                        <p class="fw-semibold fs-3 text-primary mb-1">Total Kader</p>
                        <h5 class="fw-semibold text-primary mb-0">{{ $kader }}</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="text-center">
                        <img src="{{ asset('assets/images/svgs/icon-speech-bubble.svg') }}" width="50" height="50"
                            class="mb-3" alt="" />
                        <p class="fw-semibold fs-3 text-success mb-1">Total Monitoring Pendampingan</p>
                        <h5 class="fw-semibold text-success mb-0">{{ $monitoring }}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card w-100">
                <div class="card-body">
                    <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                        ...
                        <div>
                            <select onchange="kecamatanOnChange(this)" class="form-select">
                                @foreach ($kecamatan as $id)
                                    <option value="{{ $id->id }}">{{ $id->nama_kecamatan }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="d-flex align-items-center mb-4 pb-1">
                                ...
                                <div>
                                    <h3 class="mb-0 fs-7 fw-semibold">{{ $total_balita }}</h4>
                                    <p class="fs-3 mb-0">Total Balita</p>
                                </div>
                            </div>
                            <div>
                                <div>
                                    <button class="btn btn-primary w-100">Lihat Data Balita</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 col-md-6 col-sm-12">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h5 class="card-title mb-9 fw-semibold">Data Jenis Kelamin Balita</h5>
                            ...
                                           </select>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="me-4">
                                            ...
                                            <span class="fs-2">{{ $laki_laki }}</span>
                                        </div>
                                        <div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-7 pb-2">
                        <div class="me-3 pe-1">
                            <img src="{{ asset('assets/images/profile/user-1.jpg') }}" class="shadow-warning rounded-2"
            ...
            <div class="card bg-primary border-0 w-100">
                <div class="card-body pb-0">
                    ...
                    <div class="text-center mt-3">
                        <img src="{{ asset('assets/images/backgrounds/piggy.png') }}" class="img-fluid"
                            alt="" />
                    </div>
                </div>
...
<script>
    function kecamatanOnChange(select) {
        var selectedKecamatan = select.value;
        var url = "/dashboard/kelurahan/" + selectedKecamatan;
        ...
        $.ajax({
            ...
            success: function(data) {
                var balita = data.jumlah_balita;
                var kelurahan = data.nama_kelurahan;
                var chart = {
                    series: [
                        {
                            name: "Balita Terdaftar",
                            data: balita
                        },
                    ],
                    chart: {
    ...
    var balita = <?php echo json_encode($jumlah_balita) ?>;
    var kelurahan = <?php echo json_encode($nama_kelurahan) ?>;
    var chart = {
        series: [
            {
                name: "Balita Terdaftar",
    ...
    var jenis_kelamin = <?php echo json_encode($total_jk) ?>;
    var chart = new ApexCharts(document.querySelector("#chart"), chart);
    chart.render();

    var breakup = {
        color: "#adb5bd",
        series: jenis_kelamin,
