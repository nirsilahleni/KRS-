        ...
        <div class="card-body">
            <div class="mb-4 d-flex justify-content-between">
                ...
                <div class="w-fit-content">
                    <x-atoms.select :lists="c_option($role_ref, 'name', 'name')" value="{{ $current_role->name }}" id="role_field"
                        placeholder="Pilih Sudut Pandang"></x-atoms.select>
                </div>
            </div>
