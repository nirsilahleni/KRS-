                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <div class="form-check ms-2">
                                <input class="form-check-input" type="checkbox" value="all" id="flexCheckDefault" onchange="toggleTables()" />
                                <label class="form-check-label" for="flexCheckDefault">Pilih Semua</label>
                            </div>
                        </div>
                        <x-mollecules.checkbox-group name="tables" class="gy-2" childClass="col-sm-12 col-md-6 col-lg-4" :lists="$parsedTables">
                        </x-mollecules.checkbox-group>
                    </div>
                    <div class="d-flex justify-content-end mb-10">
                        <a href="{{ route('setting.backup.index') }}" class="btn btn-light me-3">Kembali</a>
                        <button type="submit" class="btn btn-primary">Tambahkan Backup</button>
                    </div>
