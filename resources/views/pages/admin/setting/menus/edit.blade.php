        ...
        <form action="{{ route('setting.menus.update', $menu->id) }}" method="POST" id="edit-menu_form">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <x-atoms.select2 id="parent_id_field" name="parent_id" :lists="c_option($parents)" :value="[
                        'v' => $menu->parent_id,
                        't' => $menu->parent?->name,
                    ]">
                    </x-atoms.select2>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <x-atoms.input name="order" id="order_field" placeholder="Masukkan Order" type="number" min="0"
                        :value="$menu->order" />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <x-mollecules.radio-group name="location" :value="$menu->location" :lists="[
                        'sidebar' => 'Sidebar',
                        'topbar' => 'Topbar',
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <x-mollecules.radio-group name="is_active" :value="$menu->is_active" :lists="[
                        '1' => 'Aktif',
                        '0' => 'Tidak Aktif',
                    ]"></x-mollecules.radio-group>
                </div>
            ...
            <div class="d-flex justify-content-end mt-3 flex-reverse">
                <a href="{{ route('setting.menus.index') }}" class="btn btn-light me-3" cancel-btn>Kembali</a>
