<div class="d-flex justify-content-center align-items-center gap-2">
    ...
    @can($globalModule['update'])
      <button data-action="edit" data-url="{{ route('krs.pendataan.pendataan-krs.edit', $row->id) }}" data-target="#edit-pendataan-krs_modal"
    ...
    <ul class="dropdown-menu">
      <li>
        @can($globalModule['read'])
          <button data-action="edit" data-target="#show-pendataan-krs_modal" data-url="{{ route('krs.pendataan.pendataan-krs.show', $row->id) }}"
      ...
      <li>
        @can($globalModule['delete'])
          <button data-action="delete" data-url="{{ route('krs.pendataan.pendataan-krs.destroy', $row->id) }}" data-table-id="balita-table"
