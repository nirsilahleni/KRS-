    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <ul class="navbar-nav ms-2">
            <li class="nav-item d-flex flex-row">
                ...
                <a class="nav-link  nav-icon-hover ms-n3 py-2" href="/">
                    <img src="{{ asset('assets/images/logos/logo-krs.svg') }}" class="" width="150" alt="" />
                </a>
            </li>
                        ...
                        <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown"
                            ...
                            <div class="d-flex align-items-center">
                                <div class="user-profile-img">
                                    @if (auth()->user()->getRoleNames()->first() == 'kader' && auth()->user()->image)
                                        <img src="{{ getFileInfo(auth()->user()->image)['preview'] }}"
                            ...
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <span class="mb-1 d-block text-dark">{{$currentUser->getRoleNames()->first()}}</span>
                                        <p class="mb-0 d-flex text-dark align-items-center gap-2">
                                            <i class="ti ti-mail fs-4"></i> {{str_elipsis($currentUser->email, 23)}}
                                        </p>
                                    </div>
                                </div>
...
<div class="top-header " style="background: #00468C">
    <div class=" container d-flex flex-row justify-content-between align-content-center">
        ...
        <div class="d-flex flex-row gap-3 p-2">
            ...
            <h1 class="text-white fs-2 m-0 align-self-center col-12 ">{{ Date('M d, Y') }}</h1>
        </div>
    </div>
</div>
