...
Route::group(['prefix' => 'setting', 'as' => 'setting.'], function () {
    ...
    Route::get('/site-settings/history', [SiteSettingController::class, "history"])->name('site-settings.history');
    ...
    Route::get('/system-setting/history', [SystemSettingController::class, "history"])->name('system-setting.history');
