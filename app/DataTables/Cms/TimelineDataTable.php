...
class TimelineDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->rawColumns(['aksi', 'tanggal_mulai_pendaftaran', 'tanggal_selesai_pendaftaran', 'tanggal_mulai_administrasi', 'tanggal_selesai_administrasi', 'tanggal_mulai_assesmen', 'tanggal_seleksi_evaluasi_diri', 'updated_at', 'deleted_at'])
            ->setRowId('id');
    }
