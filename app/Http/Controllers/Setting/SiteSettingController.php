...
use App\DataTables\Setting\SiteSettingHistoryDataTable;
...
class SiteSettingController extends Controller
{
    ...
    {
        return $table->render('pages.admin.setting.site-settings.history');
    }

    public function restore(string $id)
    {
        $system_setting = SiteSetting::onlyTrashed()->find($id);
        if(!$system_setting) return ResponseFormatter::error("Site setting tidak ditemukan", null, 404);
